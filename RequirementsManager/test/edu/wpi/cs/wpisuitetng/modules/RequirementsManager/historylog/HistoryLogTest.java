...
public class HistoryLogTest {
	...
	public void testReqUpdateChangeFromDiff(){
		...
		assertEquals(aChange2.getChange(), "<p> Title changed from title1 to title2.</p><p> Description changed from: \"a desc\" to \"not a desc.\"</p><p> Assignee changed from [bill] to [joe].</p>");
		...
		assertEquals("<p> Title changed from Title1 to Title2.</p><p> Release Number changed from 105 to 104.</p><p> Type changed from EPIC to USER STORY.</p><p> Iteration changed from ID: 105 to 104.</p><p> Description changed from: \"TwilightSparklIsBestPony\" to \"DerpyIsBestPony.\"</p><p> Status changed from INPROGRESS to COMPLETE.</p><p> Priority changed from HIGH to LOW.</p><p> Estimate changed from 105 to 104.</p><p> Actual Effort changed from 105 to 104.</p><p> Assignee changed from [bill] to [joe].</p><p> -1 notes added.</p>",
