...
/**
 * Observer to retrieve iterations tree
 * 
 * @author Chris Hanna
 * 
...
public class RetrieveIterationObserverTree<T> implements RequestObserver{

	private RetrieveIterationControllerTree<T> controller;
	public RetrieveIterationObserverTree(RetrieveIterationControllerTree<T> controller){
