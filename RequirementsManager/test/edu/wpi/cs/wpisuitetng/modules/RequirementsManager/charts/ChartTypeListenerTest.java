 ...
 *
 */
public class ChartTypeListenerTest {
	...
	public void testChartListener(){
		...
		view.getChartBox().setSelectedIndex((view.getChartBox().getSelectedIndex()));
		assertEquals(view.getChartType(), TypeOfChart.Bar);
		
		//Select the next dropdown option.
		view.getChartBox().setSelectedIndex((view.getChartBox().getSelectedIndex()+1));
		assertEquals(view.getChartType(), TypeOfChart.Pie);
	}
}
